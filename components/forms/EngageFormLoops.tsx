...
const formStyles = {
  ...
  buttonFontSizePx: 14,
  successMessage:
    "Congratulation! You are one step closer. Please check your email for further instruction.",
  successFont: "Inter",
  successFontColor: "#2DA7DD",
  successFontSizePx: 16,
  userGroup: "",
}
const domain = "app.loops.so"

export default function EngageFormLoops() {
  ...
  const hasRecentSubmission = () => {
    ...
    if (
      ...
      setFormState(ERROR)
      setErrorMessage(
        "Repeated submissions, please try again in a little while"
      )
      return true
    }
